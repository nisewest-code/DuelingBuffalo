...
import com.dueli.ngbuf.falo.utils.support.MPclMilkey
import com.dueli.ngbuf.falo.utils.support.MissingHelth
import com.dueli.ngbuf.falo.utils.support.MissingPiggR
...
//                Analytics.openUrl(lastUrl)
    ...
    private inner class MisisngClz(val activity: LaunchBoard) : WebChromeClient() {
        override fun onHideCustomView() {
            binding.apply {
                binding.containerDuellingBuffalo.removeView(mFullScreenView)
                mFullscreenViewCallback?.onCustomViewHidden()
                mFullScreenView = null
                webView.visibility = View.VISIBLE
                binding.containerDuellingBuffalo.visibility = View.GONE
            }
        }
        ...
        override fun onShowCustomView(view: View?, callback: CustomViewCallback?) {
            binding.apply {
                ...
                binding.containerDuellingBuffalo.visibility = View.VISIBLE
                binding.containerDuellingBuffalo.addView(view)
